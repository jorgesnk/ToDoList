...
import br.senai.sp.informatica.tofolist.dao.ListaDao;
...
public class ListaRestController {
	...
	@RequestMapping(value="/lista/{id}") //valor em {}= variavel
	...
	@RequestMapping(value="/item/{idItem}"
	...
	public Lista listaId(@PathVariable long idLista){
		return listaDao.buscaLista(idLista);
	}
